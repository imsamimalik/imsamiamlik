...
<p align="center" width:"300px">	<!-- (optional) center align -->
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="theme--dark" fill="none" width="1000" height="330">
		<style>
			.gauge-base {
				opacity: 0.1
			}
		...
		<svg class="guage-div guage-perf guage-green" viewBox="0 0 200 200" width="200" height="200" x="0" y="0">
			...
			<circle class="gauge-arc guage-arc-1" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 348.33942, 351.858;"/>
		...
		<svg class="guage-div guage-acc guage-green" viewBox="0 0 200 200" width="200" height="200" x="200" y="0">
			<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"/>
			<circle class="gauge-arc guage-arc-2" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 344.82084000000003, 351.858;"/>
			<text class="guage-text" x="100px" y="60px" alignment-baseline="central" dominant-baseline="central" text-anchor="middle">98</text>
		...
		<svg class="guage-div guage-pwa " viewBox="0 0 200 200" width="200" height="200" x="800" y="0">
			<svg viewBox="0 0 60 60" width="112" height="112" x="44" y="4">
				...
				<g stroke="none" fill-rule="nonzero">
					...
					<!-- Full PWA. -->
					<g class="lh-gauge--pwa__component lh-gauge--pwa__check-circle lh-gauge--pwa__visible" transform="translate(18, 28)">
